...
int main() {
    ...
    do {
      ...
      // Movimento do Cavalo (loops aninhados) - 2 casas para baixo e 1 casa para esquerda
    // Usamos um for para as duas casas para baixo e um while para a casa para esquerda
    int casas_baixo = 2;
    ...
    // loop while para a casa para esquerda
    j = 0;
